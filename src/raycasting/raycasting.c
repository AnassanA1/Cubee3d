...
/*   Updated: 2026/02/22 19:04:07 by msidry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		init_line(t_container *rf, t_ray *ry, t_vline *ln, unsigned int x);
...
void	init_line(t_container *ref, t_ray *ray, t_vline *line, unsigned int x)
{
	...
	line->end = min(dsp->height / 2 + line->height / 2, dsp->height - 1);
}
