...
/*   Updated: 2026/02/20 02:07:16 by anasszgh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_left(t_container *ref)
{
	...
	ref->player.dir.x = ref->player.dir.x * cos(-ROT_SPEED) - ref->player.dir.y
		* sin(-ROT_SPEED);
	ref->player.dir.y = old_dir_x * sin(-ROT_SPEED) + ref->player.dir.y
		* cos(-ROT_SPEED);
	ref->player.plane.x = ref->player.plane.x * cos(-ROT_SPEED)
		- ref->player.plane.y * sin(-ROT_SPEED);
	ref->player.plane.y = old_plane_x * sin(-ROT_SPEED) + ref->player.plane.y
		* cos(-ROT_SPEED);
}
